...
[![Impulsionado por Awesome Copilot](https://img.shields.io/badge/Powered_by-Awesome_Copilot-blue?logo=githubcopilot)](https://aka.ms/awesome-github-copilot) [![Contribuidores do GitHub via allcontributors.org](https://img.shields.io/github/all-contributors/github/awesome-copilot?color=ee8449)](#contributors-)

Uma coleção criada pela comunidade de agentes personalizados, instruções, skills, hooks, workflows e plugins para potencializar sua experiência com o GitHub Copilot.

> [!TIP]
> **Explore a coleção completa no site →** [awesome-copilot.github.com](https://awesome-copilot.github.com)
>
> O site oferece busca em texto completo e filtragem em centenas de recursos, além da seção [Ferramentas](https://awesome-copilot.github.com/tools) para servidores MCP e ferramental de desenvolvimento, e do [Hub de Aprendizado](https://awesome-copilot.github.com/learning-hub) para guias e tutoriais.
>
> **Usando esta coleção em um agente de IA?** Há um [`llms.txt`](https://awesome-copilot.github.com/llms.txt) legível por máquina disponível com listagens estruturadas de todos os agentes, instruções e skills.

## 📖 Hub de Aprendizado

Está começando com a personalização do GitHub Copilot? O **[Hub de Aprendizado](https://awesome-copilot.github.com/learning-hub)** no site oferece artigos selecionados, guias passo a passo e material de referência — cobrindo desde conceitos fundamentais, como agentes, skills e instruções, até guias práticos para hooks, workflows agentivos, servidores MCP e o agente de codificação do Copilot.

## O que há neste repositório

| Recurso | Descrição | Explorar |
|----------|-------------|--------|
| 🤖 [Agentes](docs/README.agents.md) | Agentes especializados do Copilot que se integram a servidores MCP | [Todos os agentes →](https://awesome-copilot.github.com/agents) |
| 📋 [Instruções](docs/README.instructions.md) | Padrões de codificação aplicados automaticamente por padrão de arquivo | [Todas as instruções →](https://awesome-copilot.github.com/instructions) |
| 🎯 [Skills](docs/README.skills.md) | Pastas autocontidas com instruções e ativos empacotados | [Todas as skills →](https://awesome-copilot.github.com/skills) |
| 🔌 [Plugins](docs/README.plugins.md) | Conjuntos selecionados de agentes e skills para workflows específicos | [Todos os plugins →](https://awesome-copilot.github.com/plugins) |
| 🪝 [Hooks](docs/README.hooks.md) | Ações automatizadas disparadas durante sessões de agentes do Copilot | [Todos os hooks →](https://awesome-copilot.github.com/hooks) |
| ⚡ [Workflows agentivos](docs/README.workflows.md) | Automações do GitHub Actions com IA escritas em markdown | [Todos os workflows →](https://awesome-copilot.github.com/workflows) |
| 🍳 [Livro de Receitas](cookbook/README.md) | Receitas prontas para copiar e colar ao trabalhar com APIs do Copilot | — |

## 🛠️ Ferramentas

Quer entender como usar o Awesome Copilot? Consulte a **[seção Ferramentas](https://awesome-copilot.github.com/tools)** do site para servidores MCP, integrações com editores e outras ferramentas de desenvolvimento para aproveitar ao máximo esta coleção.

## Instalar um plugin

Para a maioria dos usuários, o marketplace **Awesome Copilot** já está registrado no Copilot CLI/VS Code, de modo que você pode instalar um plugin diretamente:

```bash
copilot plugin install <plugin-name>@awesome-copilot
```

Se você estiver usando uma versão mais antiga do Copilot CLI ou uma configuração personalizada e receber um erro informando que o marketplace é desconhecido, registre-o uma vez e depois instale:
...
Consulte [CONTRIBUTING.md](CONTRIBUTING.md) · [AGENTS.md](AGENTS.md) para orientações sobre agentes de IA · [Segurança](SECURITY.md) · [Código de Conduta](CODE_OF_CONDUCT.md)

> As personalizações aqui presentes são fornecidas por desenvolvedores terceiros. Inspecione qualquer agente e sua documentação antes de instalar.

## Contribuidores ✨

Agradecemos a estas pessoas incríveis ([legenda de emojis](./CONTRIBUTING.md#contributors-recognition)):


<!-- ALL-CONTRIBUTORS-LIST:START - Não remova nem modifique esta seção -->
    ...
    <tr>
      <td align="center" size="13px" colspan="7">
        <img src="https://raw.githubusercontent.com/all-contributors/all-contributors-cli/1b8533af435da9854653492b1327a23a4dbd0a10/assets/logo-small.svg">
          <a href="https://all-contributors.js.org/docs/en/bot/usage">Adicione suas contribuições</a>
        </img>
      </td>
    </tr>
  </tfoot>
...
- [Documentação de personalização do Copilot no VS Code](https://code.visualstudio.com/docs/copilot/copilot-customization) - Documentação oficial da Microsoft
- [Documentação do GitHub Copilot Chat](https://code.visualstudio.com/docs/copilot/chat/copilot-chat) - Guia completo dos recursos de chat
- [Configurações do VS Code](https://code.visualstudio.com/docs/getstarted/settings) - Guia geral de configuração do VS Code

## ™️ Marcas registradas

Este projeto pode conter marcas registradas ou logotipos de projetos, produtos ou serviços. O uso autorizado de
marcas registradas ou logotipos da Microsoft está sujeito às
